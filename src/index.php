...
<body>
  ...
  <table border=1>
    ...
    <?php
      ...
      {
          pg_query($conn,"TRUNCATE TABLE estudiantes");
          $query = "INSERT INTO estudiantes (estudiante, matricula, carrera, recinto) 
          VALUES
          ('Jean Luciano Ureña','2-17-1955','Ingeniería en Sistemas','Santiago'),
          ('Baldwin Cesé Polanco','1-16-1355','Ingeniería en Sistemas','Moca'),
          ('Anthony Alejandro','1-15-1533','Contaduría Pública','Santo Domingo')";
